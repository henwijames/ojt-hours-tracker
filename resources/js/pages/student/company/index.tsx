    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="from-background to-muted/20 @container/main flex flex-1 flex-col gap-6 bg-gradient-to-br p-6">
                ...
                {!isDialogOpen && companySubmission && (
                    <Card className="w-full shadow-lg transition-all duration-300 hover:shadow-xl">
                        <CardHeader>
                            <div className="flex flex-col items-start justify-between">
                                <div className="flex w-full items-center justify-between">
                                    <CardTitle className="text-2xl font-bold tracking-tight">{companySubmission.company_name}</CardTitle>
                                    <div className="flex items-center gap-3">
                                        <Badge
                                            variant={getVariant(companySubmission.status)}
                                            className="ml-2 flex items-center px-3 py-1.5 text-xs font-medium capitalize transition-colors duration-200"
                                        >
                                            {getIcon(companySubmission.status)}
                                            {companySubmission.status}
                                        </Badge>
                                        {(companySubmission.status === 'rejected' || companySubmission.status === 'pending') && (
                                            <Button
                                                variant="outline"
                                                size="sm"
                        ...
                        <CardContent className="space-y-8">
                            <div className="space-y-6">
                                <div className="group flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base leading-relaxed">{companySubmission.company_address}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div className="group flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base leading-relaxed">{companySubmission.supervisor_name}</p>
                                    </div>
                                </div>
                                ...
                                <div className="group flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base leading-relaxed">{companySubmission.supervisor_contact}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="group flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-base leading-relaxed">{formatDate(companySubmission.submitted_at)}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
